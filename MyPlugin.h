...
std::string gPluginName = "sam-k0.ColorfulHero.yytk";
...
namespace Misc {
    ...
    YYRValue InstanceGetVariable(YYRValue iid, std::string varname)
    {
        return CallBuiltin("variable_instance_get", nullptr, nullptr, { iid, varname });
    }
}